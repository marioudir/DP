...
# 0. Limpiarel área de trabajo (Environment)
rm(list = ls())


# 1. Descargar los datos del Censo 2020 de Michoacán en formato *.csv
...
ggplot(datos.g5, aes(x=Edad, y=Fecundidad, group=1)) +
  geom_line() +
  geom_point() +
  labs(title="Tasas de fecundidad por edad. Michoacán, 2019", 
